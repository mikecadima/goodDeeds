						...
						<div class="card">
							...
							<div class="card-content">
								<div class="media">
									...
									<div class="media-content">
										...
										<p class="subtitle is-6">
											<a href="https://github.com/mikecadima" target="_blank" rel="noopener noreferrer">
												@mikecadima
											</a>
										</p>
									</div>
								...
								<div class="tags has-addons">
									<span class="tag is-black">Authentication & Frontend</span>
								</div>
					...
					<div class="column">
						...
						<div class="card">
							...
							<div class="card-content">
								...
								<label class="label">Role</label>
								<div class="tags has-addons">
									<span class="tag is-black">Database Architecture</span>
								</div>
					...
					<div class="column">
						...
						<div class="card">
							...
							<div class="card-content">
								...
								<label class="label">Role</label>
								<div class="tags has-addons">
									<span class="tag is-black">Frontend & UX Flow</span>
								</div>
